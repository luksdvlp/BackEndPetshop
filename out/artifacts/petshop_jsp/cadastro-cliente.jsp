                        ...
                        <div class="col-md-6">
                            <form action="CadastroServlet" method="POST">
                                <fieldset>
                                    ...
                                    <input class="form-control" type="text" name="cpf" id="cpf" placeholder="digite seu cpf - somente números">
                                    <br>
                                    <label for="email">e-mail*</label>
                                    <input class="form-control" type="email" name="email" id="email" placeholder="digite seu e-mail">
                                    <br>
                                    <label for="telefone">Telefone*</label>
                                    <input class="form-control" type="text" name="telefone" id="telefone" placeholder="digite seu telefone">
                                    <br>
